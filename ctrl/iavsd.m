...
ylabel('\fontname{Times New Roman}Ctrl point 1 lateral error (m)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northwest');
...
xlabel('\fontname{Times New Roman}Time (s)');
ylabel('\fontname{Times New Roman}Ctrl point 2 lateral error (m)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northwest');
set(gcf, 'Position', [600, 400, 600, 400]); 
axis([0 58 -0.1 0.2]);
...
xlabel('\fontname{Times New Roman}Time (s)');
ylabel('\fontname{Times New Roman}Ctrl point 3 lateral error (m)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northwest');
set(gcf, 'Position', [600, 400, 600, 400]); 
axis([0 58 -0.1 0.32]);
...
xlabel('\fontname{Times New Roman}Time (s)');
ylabel('\fontname{Times New Roman}Ctrl point 4 lateral error (m)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northwest');
set(gcf, 'Position', [600, 400, 600, 400]); 
axis([0 58 -0.1 0.15]);
...
xlabel('\fontname{Times New Roman}Time (s)');
ylabel('\fontname{Times New Roman}Yaw1 error (deg)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northeast');
set(gcf, 'Position', [600, 400, 600, 400]); 
axis([0 58 -0.8 0.6]);
...
xlabel('\fontname{Times New Roman}Time (s)');
ylabel('\fontname{Times New Roman}Yaw2 error (deg)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northeast');
set(gcf, 'Position', [600, 400, 600, 400]); 
axis([0 58 -0.9 0.6]);
...
xlabel('\fontname{Times New Roman}Time (s)');
ylabel('\fontname{Times New Roman}Yaw3 error (deg)');
legend('\fontname{Times New Roman}Mechanism model', '\fontname{Times New Roman}Discrepancy model', 'Location', 'northeast');
set(gcf, 'Position', [600, 400, 600, 400]); 
axis([0 58 -0.15 0.65]);
