function yout = selected_function_im(yin, u, trq, polyorder)
...
%     % poly order 3
%     for i=1:length(allmix(1, :))
%         for j=i:length(allmix(1, :))
%             for k=j:length(allmix(1, :))
%                 yout(:,ind) = allmix(:,i).*allmix(:,j).*allmix(:,k);
%                 ind = ind+1;
%             end
%         end
%     end
...
%         for j=i:length(allmix(1, :))
%             for k=j:length(allmix(1, :))
%                 for l=k:length(allmix(1, :))
%                     yout(:,ind) = allmix(:,i).*allmix(:,j).*allmix(:,k).*allmix(:,l);
%                     ind = ind+1;
%                 end
%             end
%         end
