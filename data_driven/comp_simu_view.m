...
print(h1,'-depsc2','-loose',[FigurePath,'position_error_mcom.eps']); 
savefig(h1, [FigurePath,'/position_error_mcom.fig']);
...
set(gcf, 'Position', [600, 400, 500, 300]); 
print(h2,'-depsc2','-loose',[FigurePath,'vxerror_mcom.eps']); 
savefig(h2, [FigurePath,'/vxerror_mcom.fig']);
...
legend('\fontname{宋体}机理模型','\fontname{宋体}进化稀疏建模','\fontname{宋体}神经网络','\fontname{宋体}高斯过程回归', 'Location','southwest');
set(gcf, 'Position', [600, 400, 500, 300]); 
print(h3,'-depsc2','-loose',[FigurePath,'vyerror_mcom.eps']); 
savefig(h3, [FigurePath,'/vyerror_mcom.fig']);
...
legend('\fontname{宋体}机理模型','\fontname{宋体}进化稀疏建模','\fontname{宋体}神经网络','\fontname{宋体}高斯过程回归', 'Location','northwest');
set(gcf, 'Position', [600, 400, 500, 300]); 
print(h4,'-depsc2','-loose',[FigurePath,'yaw1error_mcom.eps']); 
savefig(h4, [FigurePath,'/yaw1error_mcom.fig']);
...
legend('\fontname{宋体}机理模型','\fontname{宋体}进化稀疏建模','\fontname{宋体}神经网络','\fontname{宋体}高斯过程回归', 'Location','northwest');
set(gcf, 'Position', [600, 400, 500, 300]); 
print(h5,'-depsc2','-loose',[FigurePath,'yaw2error_mcom.eps']); 
savefig(h5, [FigurePath,'/yaw2error_mcom.fig']);
...
legend('\fontname{宋体}机理模型','\fontname{宋体}进化稀疏建模','\fontname{宋体}神经网络','\fontname{宋体}高斯过程回归', 'Location','northwest');
set(gcf, 'Position', [600, 400, 500, 300]); 
print(h6,'-depsc2','-loose',[FigurePath,'yaw3error_mcom.eps']); 
savefig(h6, [FigurePath,'/yaw3error_mcom.fig']);
